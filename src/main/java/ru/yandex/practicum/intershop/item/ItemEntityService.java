...
public class ItemEntityService {
    ...
    public ItemEntityService(ItemRepository itemRepository) {
    ...
    public Flux<ItemEntity> findAll(GetItemsRequest request) {
        log.info("Fetching items from database for request: {}", request);
    ...
    public Mono<PageCacheDto> findAllCache(GetItemsRequest request) {
        return findAllInternal(request)
                .map(PageCacheDto::fromPage);
    }
